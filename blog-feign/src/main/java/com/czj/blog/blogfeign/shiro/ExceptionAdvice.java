...
public class ExceptionAdvice {
    ...
    public ResponseBean handle401(UnauthorizedException e) {
        return new ResponseBean(HttpStatus.UNAUTHORIZED.value(), "无权访问:当前用户没有此权限(" + e.getMessage() + ")", null);
    }
    ...
    public ResponseBean handle401(UnauthenticatedException e) {
        return new ResponseBean(HttpStatus.UNAUTHORIZED.value(), "无权访问，请先登录!", null);
    }
